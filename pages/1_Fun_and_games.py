...
from utils.genetic.operators import calculate_fitness_return_all, row_column_flip_mutation, row_column_swap_mutation
...
with tabs[0]:
    ...
    with col1:
        ...
        for individual in population:
            ...
            # st.image(draw_image_from_array(row_column_swap_mutation(individual.copy())),
            #          caption=f"Mutant")
    with col2:
