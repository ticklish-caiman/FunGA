...
st.divider()
st.write(
    "The project was created using the Streamlit framework. The premise was simple: I focus on the back-end, "
...
st.write(
    "I am a graduate of the University of Silesia in Katowice, Poland, and currently work as an IT specialist in a "
